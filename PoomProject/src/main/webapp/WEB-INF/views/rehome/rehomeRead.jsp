            ...
            <div class="card-body"  align='center' >
              <div class="table-responsive" style=" width:80%;" align='left'>
						...
						<div style="height:100%;">
							...
							<h1 style="font-size:3em;"><strong> ${rehomeRead.title}</strong></h1>
							<div><small class="text-muted"><fmt:formatDate pattern="yyyy-MM-dd" value="${rehomeRead.mod_date_b}" /></small></div>												
							<div align='right'><strong><a href="#" onClick="window.open('report?bno=${rehomeRead.bno}','window_name','width=430,height=500,location=no,status=no,scrollbars=yes');">신고</a>&nbsp;&nbsp;&nbsp;<a href='update?bno=${rehomeRead.bno}'>수정</a>&nbsp;&nbsp;&nbsp;<a href='delete?bno=${rehomeRead.bno}'>삭제</a></strong></div><br>
              	...
              	<div align="center">
								<div><button type="button" class="btn btn-sm btn-outline-secondary" style="color:white; cursor: pointer;" onclick="location.href='pay?bno=${rehomeRead.bno}&id_writer=${rehomeRead.id_writer}&id_reader=${loginMember.id}&cost=${rehomeRead.cost}'">분양받기</button></div><br>
